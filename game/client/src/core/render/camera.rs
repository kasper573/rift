//! The world camera marker and cursor un-projection into tile space (for the input gestures). Making
//! the camera follow something is bespoke and lives in `crate::systems::camera`.
