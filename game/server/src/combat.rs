//! Combat systems: engage attack targets, chase, swing on the model's timing, deal damage, emit
//! deaths, and regenerate player health over time.

use bevy_ecs::message::Messages;
use bevy_ecs::prelude::*;
use bevy_replicon::prelude::FromClient;
use bevy_time::Time;
use world::actor::{ACTION_ATTACK, ACTION_DEAD, Actor, Timing, action_name};
use world::area::AreaTag;
use world::combat::{AttackRequest, Vitals, is_dead};
...
use crate::actor::{set_action, set_facing};
...
fn attack_timing(world: &World, entity: Entity, dir: u8) -> Timing {
