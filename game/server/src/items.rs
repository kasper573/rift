//! Item use: consume a consumable from the sender's inventory and announce it to everyone who can
//! see the actor.
...
use world::items::{Inventory, ItemConsumed, ItemKind, UseItemRequest};
